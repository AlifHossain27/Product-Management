...
const YearlyTopProducts = () => {
    ...
    useEffect(() => {
      const fetchData = async () => {
          const resp = await fetch('http://localhost:8000/api/sale/yearly-top-products/');
    ...
    return (
      <div>
        ...
        <p className="text-sm text-muted-foreground">You sold {salesData.total_quantity_sold} products this year.</p>
...
export default YearlyTopProducts